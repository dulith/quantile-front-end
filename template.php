    ...
    <html lang="en">
      <head>
        ...
        <link href="css/quantile-theme.css" rel="stylesheet">
            ...
            <div class="container">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li><a href="#">Sign in</a></li></li>
                  <li class="dropdown">
                    <button type="button" class="btn nav-btn-primary col-xs-12">Sign up</button>
                  </li>
                </ul>
              </div><!--/.nav-collapse -->
            </div>
          ...
          <div class="container">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-4 margin-top-30">
                 ...
                 <h5 class="margin-top-clear margin-top-20">Business Process Management</h5>
      ...
      <!--client's testimonials section start-->
        ...
        <!--how to hire a consultant section start-->
          <section id="q-how-to-hire">
            <div class="container red-default q-how-to-hire text-center"> 
              <h3 class="margin-bottom-50">How it works?</h3>
              <div class="col-md-12">
        ...
        <!--footer section end--> 
          <section id="q-footer">
            <div class="container-fluid red-default q-footer"> 
              <div class="container">
                <div class="row-fluid">
                  <div class="col-md-8 col-sm-6">
                    © Abacus Group Pty Ltd, <script type="text/javascript">var d = new Date();document.write(d.getFullYear());</script>. All Rights Reserved.  <a href:"">Terms & Conditions<a>
                  </div>
                  <div class="col-md-4 col-sm-6">
                    <ul class="list-inline socialmedia pull-right">
                        <li class="in"></li>
                        <li class="g-plus"></li>
                        <li class="twitter"></li>
                        <li class="fb"></li>
                        <li class="you-tube"></li>
                    </ul>
                  </div>
                </div>
              </div>
